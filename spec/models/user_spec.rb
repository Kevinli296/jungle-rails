...
RSpec.describe User, type: :model do
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'should authenticate the user with the incorrect email and not log them in' do
      @user = User.new({
        :first_name => 'Pepe',
        :last_name => 'Hands',
        :email => 'pepe@peepo.com',
      ...
      @user.save
      expect(User.authenticate_with_credentials('someemail', @user.password)).to eq(nil)
    end
    it 'should authenticate the user with the incorrect password and not log them in' do
      @user = User.new({
        :first_name => 'Pepe',
        :last_name => 'Hands',
        :email => 'pepe@peepo.com',
    ...
    it 'should authenticate the user with the correct credentials (with varied cases in their email) and log them in' do
      @user = User.new({
        :first_name => 'Pepe',
        :last_name => 'Hands',
        :email => 'pepe@peepo.com',
